                ...
                <div class="logout-dropdown">
                    <div class="user-log">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->profile_photo_path): ?>
                            <img class="user" src="<?php echo e(asset('storage/' . auth()->user()->profile_photo_path)); ?>?v=<?php echo e(time()); ?>" alt="<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>">
                        <?php else: ?>
                    ...
                    <ul class="dropdown-options">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin()): ?>
                            <li><a href="<?php echo e(route('api-tokens.index')); ?>" class="dropdown-link">API Tokens</a></li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <li><a href="<?php echo e(route('dashboard')); ?>" class="dropdown-link">Dashboard</a></li>
    ...
    <section class="profile-page">
        <div class="profile-container">
            ...
            <div class="profile-section">
                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="profile-form" data-profile-update-route="<?php echo e(route('profile.update')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="profile-photo-section">
                    ...
                    <div class="profile-photo-wrapper">
                        <div class="profile-photo-circle">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->profile_photo_path): ?>
                                <img src="<?php echo e(asset('storage/' . auth()->user()->profile_photo_path)); ?>?v=<?php echo e(time()); ?>"
                                    alt="Profile"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <!-- Hidden form to submit cropped image -->
                    ...
                    <div class="profile-field">
                        ...
                        <input type="text" id="name" name="first_name" value="<?php echo e(old('first_name', auth()->user()->first_name)); ?>" required class="profile-input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="profile-field">
                        ...
                        <input type="text" id="name" name="last_name" value="<?php echo e(old('last_name', auth()->user()->last_name)); ?>" required class="profile-input">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="profile-field">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email', auth()->user()->email)); ?>" required class="profile-input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasVerifiedEmail()): ?>
                            <div class="email-unverified">
                                ...
                                <form method="POST" action="<?php echo e(route('verification.send')); ?>" class="inline-form">
                                    <?php echo csrf_field(); ?>
                ...
                <form id="cropForm" method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
                ...
                <form method="POST" action="<?php echo e(route('profile.password.update')); ?>" class="profile-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="session-item">
                                ...
                                <div class="session-details">
                                    <div class="session-device"><?php echo e($session->agent->platform() ?? 'Unknown'); ?> - <?php echo e($session->agent->browser() ?? 'Unknown'); ?></div>
                                    <div class="session-meta"><?php echo e($session->ip_address); ?>
                ...
                <div id="logout-sessions-form" class="modal">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?php echo e(route('profile.sessions.logout')); ?>" class="modal-form">
                            <?php echo csrf_field(); ?>
...
[$__name, $__params] = $__split('address-manager');
...
?>
                ...
                <div class="profile-section">
                    ...
                    <div class="twofa-box">
                        <p class="twofa-status">Two factor authentication is currently <strong><?php echo e(auth()->user()->two_factor_secret ? 'ENABLED' : 'DISABLED'); ?></strong>.</p>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->two_factor_secret): ?>
                            <p class="twofa-instruction">Scan this QR code with Google Authenticator:</p>
                            <div class="qr-code">
                                <?php echo auth()->user()->twoFactorQrCodeSvg(); ?>

                            </div>
                            <form method="POST" action="<?php echo e(route('two-factor.disable')); ?>" class="inline-form">
                                <?php echo csrf_field(); ?>
                ...
                <div class="profile-section delete-section">
                    ...
                    <div id="delete-account-form" class="modal">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="<?php echo e(route('profile.destroy')); ?>" class="modal-form">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
