    ...
    <section class="sectiune-adrese" id="sectiune-adrese-order">
        ...
        <div class="container-adrese">
            ...
            <div class="youradress" id="youraddress-order">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($addresses) > 0): ?>
            ...
            <div class="formular-adrese" id="formular-adrese-order">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($useNewAddress): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            <button wire:click="placeOrder" class="btn-adrese" id="order-btn-payment">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment_method === 'card'): ?>
                    Proceed to Payment
                <?php else: ?>
                    Place Order
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
</div><?php /**PATH /var/www/html/resources/views/livewire/order-address-details.blade.php ENDPATH**/ ?>