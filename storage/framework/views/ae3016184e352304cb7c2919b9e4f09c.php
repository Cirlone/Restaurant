<div>
        <form wire:submit="subscribe">
            <div class="form-newsletter">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['mail'];
...
</div><?php /**PATH /var/www/html/resources/views/livewire/newsletter-form.blade.php ENDPATH**/ ?>