<div>
    <form wire:submit="submit" class="form-contact">
        ...
        <div class="row2">
            <input class="input-date" type="date" placeholder="Date" wire:model.live="date" min="<?php echo e(now()->format('Y-m-d')); ?>">
...
</div><?php /**PATH /var/www/html/resources/views/livewire/reservation-form.blade.php ENDPATH**/ ?>